...
AGENTS={'Hermes':'default','Blaze':'blaze','Blaze2':'blaze2','Bolt':'bolt','Bolt2':'bolt2','Kaijeaw':'kaijeaw','Bookthai':'bookthai','Protocol':'protocol','Qwen':'qwen','Signal':'signal','OData':'odata','Zegna':'zegna','Zegna2':'zegna2'}
